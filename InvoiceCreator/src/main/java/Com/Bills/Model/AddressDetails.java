...
import Com.Bills.Util.ConstantUtil;
...
public class AddressDetails {
    ...
    private String billingPhoneNumberText = ConstantUtil.BILLING_PHONE;  // Add this line
    private String billingPhoneNumber = ConstantUtil.EMPTY;  // Add this line
    ...
    public AddressDetails setBillingPhoneNumberText(String billingPhoneNumberText) {  // Add this method
        this.billingPhoneNumberText = billingPhoneNumberText;
        return this;
    }

    public AddressDetails setBillingPhoneNumber(String billingPhoneNumber) {  // Add this method
